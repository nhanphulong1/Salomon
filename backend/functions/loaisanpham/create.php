        ...
        <div class="row">
            ...
            <div class="col-md-9 content">
                ...
                <form action="" method="post" name="frmLoaiSanPham" id="frmLoaiSanPham">
                    ...
                    <input type="text" name="lsp_ten" class="form-control"><br>
                    <label>Nhập mô tả:</label><br>
                    <textarea name="lsp_mota" class="form-control" rows="10"></textarea><br>
                ...
                <?php
                    if(isset($_POST['btnLuu'])){
                          ...
                          ) 
                        {
                                ...
                                $caulenh = "INSERT INTO loaisanpham(lsp_ten,lsp_mota) VALUES ('$ten','$mota')";
